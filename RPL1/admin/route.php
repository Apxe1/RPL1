        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($route_added)
                {
                    ...
                    <strong>Successful!</strong> Rute Ditambahkan
                    ...
                    <strong>Error!</strong> Rute sudah ada
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                else 
                {
                    ...
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> dtail rute sudah ada
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    $messageInfo = "Rute Details dihapus";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Rute Tidak DiTemukan</h1>
                        <p class="fw-light">Jadi pemesan pertama</p>
                        <hr>
            ...
            <?php }
                ...
                <section id="route">
                    ...
                    <div id="route-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah Rute <i class="fas fa-plus"></i></button>
                        </div>
                        <table class="table table-hover table-bordered">
                            <thead>
                                <th>ID</th>
                                <th>Tempat Kedatangan</th>
                                <th>Bus</th>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">Tempat keberangkatan</label>
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">Nomor Bus</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">Harga</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">Waktu Berangkat</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Apakah Anda Yakin Ingin Menghapus Tujuan Perjalanan? <strong></strong>
                </p>
                <!-- Needed to pass id -->
