        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    ...
                    <p>
                        <em><b>Dipesan dari:</b> <br><?php echo $booked_timing; ?></em>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="text-center">
                    <h4><b>KODE BOOKING:</b> <?php echo $pnr; ?></h5>
                    <h2>Detail Ticket</h2>
                </div>
                </span>
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nama Pemesan:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Detail Kontak :</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Rute:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nomor Bus:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nomor Kursi:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Tanggal keberangkatan:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Waktu keberangkatan:</b></em></h4></td>
