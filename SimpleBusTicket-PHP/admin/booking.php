        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($booking_added)
                {
                    ...
                    <strong>Error!</strong> pesanan sudah ada
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Detail pemesanan diubah";
                    }
                    else{
                        // Show error alert
            ...
            if(isset($_POST["delete"]))
            {
                ...
                if(!$rowsAffected)
                {
                    $messageInfo = "Tidak ada pembaruan";
                }

                elseif($deleteResult)
                {   
                    $messageStatus = "sukses";
                    $messageInfo = "detail pemesanan dihapus";
                    $messageHeading = "Berhasil!";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Tiket tidak ditemukan</h1>
                        <p class="fw-light">jadi yang pertama memesan</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">tambah <i class="fas fa-plus"></i></button> Untuk menambah pesanan!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah pemesan<i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">ID Pemesan</label>
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">Nama Customer</label>
                                <input type="text" class="form-control" id="cname" name="cname" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="cphone" class="form-label">Nomor Hp</label>
                                <input type="tel" class="form-control" id="cphone" name="cphone" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="routeSearch" class="form-label">Rute</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">Tujuan</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">Nomor Kursi</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    Hanya bisa meemilih max 1 kursi.
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">Harga</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Apakah anda yakin ingin menghapus pesanan ini? <strong>proses ini tidak bisa di pulihkan</strong>
                </p>
                <!-- Needed to pass id -->
