    ...
    if(!$conn) 
        ...
        if(isset($_GET['error'])) {
            ...
            if($_GET['error'] == "password_wrong") {
                $errorMessage = 'Password salah. Silahkan coba kembali.';
            } elseif($_GET['error'] == "user_not_found") {
                $errorMessage = 'Username tidak ditemukan. Silakan cek kembali username Anda.';
            }
            
            if(!empty($errorMessage)) {
                echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showErrorModal('" . addslashes($errorMessage) . "');
                        });
                      </script>";
            }
        }
...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["pnr-search"]))
    {
        ...
        if($num)
        {
            ...
            <h4 class="alert-heading">Informasi Pemesanan</h4>
            <p>
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Kursi yang dipilih : </strong>
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["deleteBtn"]))
        {
            ...
            $deleteSql = "DELETE FROM `bookings` WHERE `bookings`.`booking_id` = '$pnr'";
                ...
                {   
                    ...
                    $messageInfo = "Permintaan Anda tidak dapat diproses karena masalah teknis dari pihak kami. Kami mohon maaf atas ketidaknyamanan yang ditimbulkan";
                }
    ...
    <nav>
            <div>
                    <a href="#" class="nav-item nav-logo"><img src="assets/img/AnKOT.png" alt="Logo" class="logo-img"></a>
            ...
            <div>
                ...
                <a href="#pnr-enquiry" class="pnr nav-item">Check Tiket</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to AnKot, your gateway to Anda menuju petualangan tak terlupakan dan pengalaman perjalanan yang dipersonalisasi. Didirikan pada tahun 2024, kami berdedikasi untuk menciptakan perjalanan luar biasa yang menginspirasi, memperkaya, dan menghubungkan wisatawan dengan dunia.</p>

            <center>
                <button class="btn btn-danger " data-bs-toggle="modal" data-bs-target="#loginModal">Login Sebagai Admin</button>
                
            </center>

            <br>
            <center>
            <a href="#pnr-enquiry"><button class="btn btn-primary">Scroll Ke Bawah <i class="fa fa-arrow-down"></i></button></a>
            </center>
    ...
    <div id="block">
        <section id="info-num">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <span class="icon-name">Tiket Instant</span>
                </figcaption>
            </figure>
        </section>
        <section id="pnr-enquiry">
            <div id="pnr-form">
                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="POST">
                    <div>
                        <input type="text" name="pnr" id="pnr" placeholder="KODE BOOKING">
                    </div>
        ...
        <section id="about">
            <div>
                ...
                <p>
                    AntarKota atau lebih dikenal dengan sebutan AnKot Didirikan pada tahun 2024 yang mana ide tersebut datang dikarenakan tugas Uas RPL 1 di universitas komputer Indonesia .
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - AngKot
                        </p>
        </footer>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <p>
            Apakah Anda benar-benar ingin menghapus pemesanan ini? <strong></strong>
            </p>
            <!-- Needed to pass pnr -->
