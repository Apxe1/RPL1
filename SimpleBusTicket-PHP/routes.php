...
<body>
    ...
    <header>
        <nav id="navbar">
            <div>
                <a href="#" class="nav-item nav-logo">Angkot</a>
    ...
    <main id="container">
        <section id="searched-route">
            <ul>
                <li class="searched-route-item" id="">Total Hasil : <span id="result-num">
                    <?php 
                        echo $count;
                    ?>
                </span></li>
            ...
            {?>
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">
                            Saat ini tidak ada layanan untuk rute yang ditentukan
                        </p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                            Kami akan segera menyediakan rute ini untuk layanan
                        </div>
                    </div>
                </div>
            <?php }
